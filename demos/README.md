...
1. **Live ISOs** — drag installers onto a big exFAT volume (toolkit stick).
2. **Installed OSes** — thin Btrfs installs plus a small branded service volume so Windows still knows what the stick is.
3. **Both** — ISO drop zone and install pool together when the stick is large enough.
